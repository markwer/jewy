fetch('https://weibo-virid.vercel.app/api').then(data => data.json()).then(data => {
  ...
  for (let item of data) {
    html += '<div class="weibo-list-item"><div class="weibo-hotness ' + hotness[(item.hot || '��')] + '">' + (item.hot || '��') + '</div>'
